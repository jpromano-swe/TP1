...
| `tp1_combinar` | O(n) | Recorre los dos vectores ya ordenados. Cada pokemon se procesa una vez y se comparan y copian los nombres. Considerando nombres de longitud mucho menor que la cantidad de pokemons, queda O(n). |
